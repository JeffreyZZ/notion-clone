...
function Heading_1(props) {
    ...
    const [initialValue, setInitialValue] = useState(props.page_element.heading_1[0].heading_text);
    const [heading_1, set_heading_1] = useState(props.page_element.heading_1[0].heading_text)

    const handleBlur = () => {
        if (heading_1 !== initialValue) {
            props.edit_H1(props.page_element.heading_1[0].id, heading_1);
            setInitialValue(heading_1);
        }
    };
