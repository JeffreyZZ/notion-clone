...
function Heading_2(props) {
    ...
    const [initialValue, setInitialValue] = useState(props.page_element.heading_2[0].heading_text);
    const [heading_2, set_heading_2] = useState(props.page_element.heading_2[0].heading_text)

    const handleBlur = () => {
        if (heading_2 !== initialValue) {
            props.edit_H2(props.page_element.heading_2[0].id, heading_2);
            setInitialValue(heading_2);
        }
    };
